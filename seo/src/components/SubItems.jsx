...
class SubItems extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            subItemsFromStore: AddStore.getAll()
        };
    }
    ...
    addSubItem() {
        let subItem = this.state.subItems;
        ...
        AddStore.addNewItemHandler({
            id: subItem.length,
            name: '',
            url: ''
        });
        console.log(AddStore.getAll());
    }
    ...
    componentDidMount() {
        AddStore.addChangeListener(this.updateSubItemVal);
    }
