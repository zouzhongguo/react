  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>159/169</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">76.86% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>93/121</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>138/144</span>
      </div>
    </div>
  </div>
...
&nbsp;
  var windowInnerHeight = window.innerHeight || <span class="branch-1 cbranch-no" title="branch not covered" >document.documentElement.clientHeight;</span>
&nbsp;
...
&nbsp;
  var offsets = Array.isArray(component.props.offset) ? <span class="branch-0 cbranch-no" title="branch not covered" >component.props.offset </span>: [component.props.offset, component.props.offset]; // Be compatible with previous API
&nbsp;
...
&nbsp;
  _createClass(LazyLoad, [{
    ...
    value: function componentDidMount() {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof process !== 'undefined' &amp;&amp; process.env.NODE_ENV !== 'production') {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (_react2.default.Children.count(this.props.children) &gt; 1) {
<span class="cstat-no" title="statement not covered" >          console.warn('[react-lazyload] Only one child is allowed to be passed to `LazyLoad`.');</span>
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.props.wheel) {
          // eslint-disable-line
<span class="cstat-no" title="statement not covered" >          console.warn('[react-lazyload] Props `wheel` is not supported anymore, try set `overflow` for lazy loading in overflow containers.');</span>
        }
&nbsp;
...
&nbsp;
      ...
      } else <span class="missing-if-branch" title="if path not taken" >I</span>if (delayType === 'debounce' &amp;&amp; this.props.debounce === undefined) {
<span class="cstat-no" title="statement not covered" >        console.warn('[react-lazyload] Previous delay function is `debounce`, now switching to `throttle`, try setting them unanimously');</span>
<span class="cstat-no" title="statement not covered" >        needResetFinalLazyLoadHandler = true;</span>
      }
&nbsp;
...
&nbsp;
      if (!finalLazyLoadHandler) {
        if (this.props.debounce !== undefined) {
          finalLazyLoadHandler = (0, _debounce2.default)(lazyLoadHandler, typeof this.props.debounce === 'number' ? <span class="branch-0 cbranch-no" title="branch not covered" >this.props.debounce </span>: 300);
          delayType = 'debounce';
        } else {
          finalLazyLoadHandler = (0, _throttle2.default)(lazyLoadHandler, typeof this.props.throttle === 'number' ? <span class="branch-0 cbranch-no" title="branch not covered" >this.props.throttle </span>: 300);
          delayType = 'throttle';
        }
      }
&nbsp;
...
&nbsp;
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (scroll) {
          (0, _event.on)(window, 'scroll', finalLazyLoadHandler);
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (resize) {
<span class="cstat-no" title="statement not covered" >          (0, _event.on)(window, 'resize', finalLazyLoadHandler);</span>
        }
      }
&nbsp;
      listeners.push(this);
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sun Sep 18 2016 06:54:00 GMT+0800 (CST)
</div>
</div>
